...
public class Utility {
    ...
    public static boolean usingLocalGraphics(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        String sunshineArtPack = context.getString(R.string.pref_icons_default);
    ...
    public static String getArtUrlForWeatherCondition(Context context, int weatherId) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        String formatArtUrl = prefs.getString(context.getString(R.string.pref_icons_key),
                context.getString(R.string.pref_icons_default));
        // Based on weather code data found at:
        // http://bugs.openweathermap.org/projects/api/wiki/Weather_Condition_Codes
        if (weatherId >= 200 && weatherId <= 232) {
    ...
    @SunshineSyncAdapter.LocationStatus public static int getLocationStatus(Context c) {
        return PreferenceManager.getDefaultSharedPreferences(c)
                .getInt(c.getString(R.string.pref_location_status_key),
    ...
    public static void resetLocationStatus(Context c) {
        PreferenceManager.getDefaultSharedPreferences(c)
                .edit()
                .putInt(c.getString(R.string.pref_location_status_key),
                        SunshineSyncAdapter.LOCATION_STATUS_UNKNOWN)
                .apply();
    }
}
